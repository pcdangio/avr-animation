/// \file animation/step/step.hpp
/// \brief Defines the animation::step::step class.
#ifndef ANIMATION___STEP___STEP_H
#define ANIMATION___STEP___STEP_H

// arduino
#include <Arduino.h>

namespace animation {
/// \brief Contains all code for animation steps.
namespace step {
